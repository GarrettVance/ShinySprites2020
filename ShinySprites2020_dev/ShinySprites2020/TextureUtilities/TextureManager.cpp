...
//  not #define STB_IMAGE_WRITE_IMPLEMENTATION
//  not #include "stb_image_write.h"
...
Texture* TextureManager::createTextureFromMemory( // ghv; 
    const char * name, 
...
)
{
	...
	newTexture->m_imageData = stbi_load_from_memory(
        buffer, 
        bufLength,
        &newTexture->m_width, 
        &newTexture->m_height, 
